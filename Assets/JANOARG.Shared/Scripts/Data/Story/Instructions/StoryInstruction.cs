...
namespace JANOARG.Shared.Data.Story.Instructions
{
    ...
    public abstract class StoryInstruction
    {
        ...
        /// </summary>
        public virtual void OnTextBuild(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { }
        ...
        /// </summary>
        public virtual void AddChoices(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { }
        ...
        /// </summary>
        public virtual void CheckStoryFlags(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { }
        ...
        /// </summary>
        public virtual IEnumerator OnTextReveal(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }

        /// <summary>
        /// Changes the background of the story.
        /// </summary>
        public virtual IEnumerator OnBackgroundChange(JANOARG.Client.Behaviors.Storyteller.Storyteller storyteller) { yield return null; }

        /// <summary>
        /// This method is called when an actor action is performed.
        /// Like changing the actor's sprite, position, etc.
        /// </summary>
        public virtual IEnumerator OnActorAction(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }

        /// <summary>
        /// This method is called when the music is played.
        /// </summary>
        public virtual IEnumerator OnMusicPlay(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }

        /// <summary>
        /// This method is called when a sound effect is played.
        /// </summary>
        public virtual IEnumerator OnSFXPlay(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }

        /// <summary>
        /// This method is called when the interface is changed.
        /// It can be used to update the UI elements in the story.
        /// </summary>
        public virtual IEnumerator OnInterfaceChange(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }
        ...
        /// </summary>
        public virtual IEnumerator OnTextAreaSwitch(JANOARG.Client.Behaviors.Storyteller.Storyteller teller) { yield return null; }
