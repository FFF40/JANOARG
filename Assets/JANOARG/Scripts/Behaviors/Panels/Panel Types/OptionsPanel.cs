...
using JANOARG.Scripts.Behaviors.Options;
...
namespace JANOARG.Scripts.Behaviors.Panels.Panel_Types
{
    public class OptionsPanel : MonoBehaviour
    {
        ...
        public void Close()
        {
            ...
            CommonSys.main.Preferences.Save();
        ...
        public void MakeTab(int tab) 
        {
            ...
            Storage Preferences = CommonSys.main.Preferences;
