...
namespace JANOARG.Scripts.Behaviors.Common
{
    ...
    public class ProfileBar : MonoBehaviour
    {
        ...
        {
            // Name
            NameLabel.text = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:Name", "JANOARG");
        
            // Levels
            int level = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:Level", 1);
            LevelText.text = level.ToString();
            LevelProgressBar.maxValue = Helper.GetLevelGoal(level);
            LevelProgressBar.value = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:LevelProgress", 0L);

            // Currencies
            CoinLabel.text = Helper.FormatCurrency(global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("CURR:Coins", 0L));
            OrbLabel.text = Helper.FormatCurrency(global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("CURR:Orbs", 0L));
        ...
        IEnumerator SongGainRoutine(long baseOrbs, long baseCoins)
        {
            ...
            long orbsOld = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("CURR:Orbs", 0L),
                orbsNew = orbsOld + finalOrbs;
            long coinsOld = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("CURR:Coins", 0L),
                coinsNew = coinsOld + finalCoins;

            // Calculate final level and progress
            int levelOld = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:Level", 1),
                levelNew = levelOld;
            long progOld = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:LevelProgress", 0L),
            ...
            // Save
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("CURR:Coins", coinsNew);
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("CURR:Orbs", orbsNew);
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("INFO:Level", levelNew);
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("INFO:LevelProgress", progNew);
            ...
            if (bonusMult > 1)
            {
                ...
                int index = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:BonusCount", 0) - 1;
        ...
        void UpdateDailyCoinBonus() 
        {
            ...
            bonusCount = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:BonusCount", 0);
            bonusReset = global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Get("INFO:BonusReset", 0L);
        ...
        int GetDailyCoinBonus() 
        {
            ...
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("INFO:BonusCount", bonusCount);
            global::JANOARG.Scripts.Behaviors.Common.CommonSys.main.Storage.Set("INFO:BonusReset", bonusReset);
            return multi;
        }
