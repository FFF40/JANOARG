...
namespace JANOARG.Scripts.Behaviors.Song_Select
{
    public class SongSelectReadyScreen : MonoBehaviour
    {
        ...
        public void BeginLaunch() 
        {
            ...
            rt.SetParent(CommonSys.main.CommonCanvas);
        ...
        public IEnumerator BeginLaunchAnim() 
        {
            ...
            OverallProgress.color =
                CurrentProgress.color = (Color.white - CommonSys.main.MainCamera.backgroundColor) * new ColorFrag(a: 1);
