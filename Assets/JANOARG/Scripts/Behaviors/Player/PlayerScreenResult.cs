...
namespace JANOARG.Scripts.Behaviors.Player
{
    public class PlayerScreenResult : MonoBehaviour
    {
        ...
        IEnumerator ResultAnim()
        {
            ...
            SongDifficultyText.color = CommonSys.main.Constants.GetDifficultyColor(PlayerScreen.TargetChartMeta.DifficultyIndex);
        ...
        IEnumerator ContinueAnim()
        {
            ...
            yield return Ease.Animate(1, a => {
                ...
                FlashBackground.color = Color.Lerp(backColor, CommonSys.main.MainCamera.backgroundColor, lerp3);
                IsAnimating = true;
            });
