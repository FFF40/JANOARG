...
public class HeadlessPlayerStarter : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        Common.main.MainCamera.backgroundColor = _targetSong.BackgroundColor;
        ...
        Common.Load("Player", () => PlayerScreen.main && PlayerScreen.main.IsReady, () => { PlayerScreen.main.BeginReadyAnim(); }, true);
