...
namespace JANOARG.Client.Behaviors.Intro
{
    public class IntroScreen : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("isFirstStart")] [Header("Data")]
        ...
        private bool ScreenTouchedThisFrame()
        {
            return Touchscreen.current?.primaryTouch?.phase.value == TouchPhase.Began;
        }
        ...
        public IEnumerator IntroEnterRoutine()
        {
            ...
            CoverMiddle.anchorMax = new Vector2(1, CoverMiddle.anchorMax.y);
        ...
        public IEnumerator IntroExitRoutine()
        {
            ...
            CommonSys.sMain.MainCamera.backgroundColor = Color.black;
