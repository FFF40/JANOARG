...
namespace JANOARG.Client.Behaviors.Options
{
    public class OptionInputHandler : MonoBehaviour
    {
        ...
        /**
            <summary>
                Register an input field to be edited.
            </summary>
            <param name="item">The item needing to be edited.</param>
        */
        ...
        /**
            <summary>
                Animation to be played when an input field is selected to be edited.
            </summary>
            <param name="item">The item to be edited.
        */
        ...
        /**
            <summary>
                End the edit and hide the input handler.
            </summary>
        */
        public void EndEdit() 
        {
        ...
        /**
            <summary>
                Animation to be played when an input field is completed editing.
            </summary>
        */
        ...
        /**
            <summary>
                Animate moving between the <c>from</c> and <c>to</c> objects via the <c>textAnim</c> object.
            </summary>
            <param name="textAnim">The TextMeshPro object to be animated.</param>
            <param name="from">The starting TeshMeshPro pbject.</param>
            <param name="to">The ending TeshMeshPro pbject.</param>
            <param name="lerp">Current progress.</param>
        */
        ...
        /**
            <summary>
                Toggle the advanced state of the current input field.
            </summary>
        */
        ...
        /**
            <summary>
                Set the advanced state of the current input field.
            </summary>
            <param name="type">The multi value type.</param>
        ...
        */
        ...
        /**
            <summary>
                Animation to be played when the current input field's advanced state is changed.
            </summary>
        */
